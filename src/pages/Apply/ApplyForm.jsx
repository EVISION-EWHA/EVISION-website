...
function ApplyForm() {
    ...
    const onhandlePost = async (data) => {
        const {studentId,studentPw,name,phone,department,privacy,management,contentA,contentB} = data;
        const postData = {studentId,studentPw,name,phone,department,privacy,management,contentA,contentB};
        postData.studentId = data.studentId; 
        postData.studentPw = data.studentPw;
        postData.name = data.name;         postData.phone = data.phone;         postData.department = data.department;
        postData.privacy = data.privacy;         postData.management= data.management;
...
return(
    ...
    <div className = "ApplyForm">
        ...
        <button type = "submit" name = "submit" id = "submit" onClick={()=>{handleSubmit()}}>제출하기</button>
    </div>
);
};
