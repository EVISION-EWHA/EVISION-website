...
const MyPage = () => {
    ...
    <div className = "MyPage">
        <br/><h2 style = {{ textAlign : "center", fontSize : "35px",}}>마이 페이지</h2>
        <form>
        <label>아이디 : {localStorage.getItem("userId")} </label><br/>
        
        <label>비밀번호 : {localStorage.getItem("userPw")}</label><br/>

        <label>이메일 : {state.email}</label><br/>
